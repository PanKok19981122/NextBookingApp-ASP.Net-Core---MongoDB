    ...
    public class UsersController : ControllerBase
    {
        ...
        public ActionResult<CreditHistory> BuyCredits(BuyCreditsViewModel input)
        {
            ...
            var creditHistory = new CreditHistory()
            {
                ...
                UserId = user.Id,
                PaypalPaymentId = input.PaypalPaymentId
            };
        ...
        public ActionResult<TrainingLocation> SaveTrainingLocation(TrainingLocation trainingLocationVM)
        {
            ...
            try
            {
                ...
                if (trainingLocationVM.Id == null || trainingLocationVM.Id == Guid.Empty)
                {
                ...
                {
                    trainingLocation = user.TrainingLocations.Find(x => x.Id == trainingLocationVM.Id);
                    ...
                    var toRemove = user.TrainingLocations.Find(x => x.Id == trainingLocationVM.Id);
        ...
        public ActionResult<List<CoachViewModel>> GetCoaches(CoachFilterViewModel coach)
        {
            ...
            foreach (var item in coaches)
            {
                ...
                {
                    p.MediaURL = p.MediaURL != null ? ((p.MediaURL.Contains("http://") || p.MediaURL.Contains("https:/")) ? p.MediaURL : p.MediaURL) : "";
                }
        ...
        public ActionResult<SearchPostResultViewModel> SearchPost(SearchPostViewModel post)
        {
            ...
            if (isStartWithHash)
            {
                ...
                coaches.ForEach(user => user.Posts.ForEach(x => x.MediaURL = x.MediaURL));
            ...
            else
            {
                ...
                users.ForEach(user => user.Posts.ForEach(x => x.MediaURL = x.MediaURL));
        ...
        public ActionResult<BookingReviewViewModel> SaveBookingReview(BookingReviewViewModel reviewVM)
        {
            ...
            booking.BookingStatus = reviewVM.BookingStatus;
            if (booking == null)
            {
                return Unauthorized(new ErrorViewModel() { errors = new Error() { error = new string[] { "User not found." } } });
            }
